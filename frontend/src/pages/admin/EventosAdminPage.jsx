    ...
    <div className="bg-white rounded-2xl shadow-card p-6 border border-surface-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          {imagePreview ? (
            <div className="relative w-full h-40 rounded-xl overflow-hidden border border-surface-200 group">
            ...
            <button
              ...
              className="w-full h-32 rounded-xl border-2 border-dashed border-surface-300 hover:border-casatic-500 flex flex-col items-center justify-center gap-2 text-surface-400 hover:text-casatic-600 transition-colors"
            >
              <Upload size={24} />
          ...
          <td colSpan="4" className="px-4 py-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              <div className="space-y-2">
                ...
                {imagenUrl && (
                  <div>
                    <img src={imagenUrl} alt="Imagen" className="w-full h-24 object-cover rounded-lg mt-1" />
                  </div>
                )}
              </div>
            </div>
