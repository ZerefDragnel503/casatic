...
import {
  ...
  Users, Video, Globe, ChevronRight
} from 'lucide-react';
...
function EventoCard({ evento }) {
  ...
  return (
    <div className="group bg-white rounded-xl shadow-card border border-surface-100 overflow-hidden hover:shadow-elevated transition-all duration-300 hover:-translate-y-1">
      {/* Imagen */}
      {imagenUrl && (
        <div className="h-48 bg-gradient-to-br from-casatic-100 to-casatic-50 overflow-hidden">
          <img
            src={imagenUrl}
            alt={evento.titulo}
  ...
  return (
    ...
    >
      ...
      >
        {/* Imagen */}
        {imagenUrl && (
          <div className="h-64 bg-gradient-to-br from-casatic-100 to-casatic-50 overflow-hidden">
            <img
              src={imagenUrl}
              alt={evento.titulo}
